...
type ApiListPermissionsGroupsRequest struct {
	ctx        context.Context
	ApiService *PermissionsApiService
}

func (r ApiListPermissionsGroupsRequest) Execute() ([]PermissionGroup, *http.Response, error) {
	return r.ApiService.ListPermissionsGroupsExecute(r)
}
...
Fetch all PermissionsGroups, including a count of the number of :members in that group. This API requires superuser or group manager of more than one group. Group manager is only available if advanced-permissions is enabled and returns only groups that user is manager of.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListPermissionsGroupsRequest
*/
func (a *PermissionsApiService) ListPermissionsGroups(ctx context.Context) ApiListPermissionsGroupsRequest {
	return ApiListPermissionsGroupsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *PermissionsApiService) ListPermissionsGroupsExecute(r ApiListPermissionsGroupsRequest) ([]PermissionGroup, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PermissionsApiService.ListPermissionsGroups")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *PermissionsApiService) GetPermissionsGroup(ctx context.Context, groupId int32) ApiGetPermissionsGroupRequest {
	return ApiGetPermissionsGroupRequest{
		ApiService: a,
		ctx:        ctx,
		groupId: groupId,
...
func (a *PermissionsApiService) GetPermissionsGroupExecute(r ApiGetPermissionsGroupRequest) (PermissionGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/group/{groupId}"
